...
import com.example.gocantar.connectingthings.common.base.extension.inflate
...
class ScannedDevicesAdapter(private val mRecyclerView: RecyclerView, private val mList: MutableMap<String, BLEDeviceView>,  private val mListener: (String)->Unit): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
